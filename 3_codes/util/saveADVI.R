...
# ------------------------------------------------------------------------------
# About this code
# estimate by ADVI instead of NUTS (MCMC) given a data frame and Stan code
# ADVI is an approximation method: check if the result is consistent with MCMC
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
  ...
  # stanmodel
  stanmodel <- 
    stan_model(file = paste("stan/", stan.file, ".stan", sep = ""))
...
# ------------------------------------------------------------------------------
  ...
  if (train) {
    save(out.list, file = paste("../5_tmp/ADVI_", stan.file, "_train.rda", sep = ""))
  } else {
    save(out.list, file = paste("../5_tmp/ADVI_", stan.file, ".rda", sep = ""))
  }
}
